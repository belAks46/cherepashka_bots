...
#define BIN2 27 // ESP32 Pin D27 to TB6612FNG Pin BIN2 - ДОБАВЬТЕ ЭТУ СТРОКУ
#define PWMA 26 // ESP32 Pin D26 to TB6612FNG Pin PWMA - ДОБАВЬТЕ ЭТУ СТРОКУ
#define PWMB 25 // ESP32 Pin D25 to TB6612FNG Pin PWMB - ДОБАВЬТЕ ЭТУ СТРОКУ
#define STBY 33 // ESP32 Pin D33 to TB6612FNG Pin STBY - ДОБАВЬТЕ ЭТУ СТРОКУ

const char* ssid = "Ygcvhu"; // ДОБАВЬТЕ ЭТУ СТРОКУ
const char* password = "Li3a2006"; // ДОБАВЬТЕ ЭТУ СТРОКУ

#define RELAY_PIN 15 // pin G15 - ДОБАВЬТЕ ЭТУ СТРОКУ
...
void move(int direction, int speed) {
  if (direction == 11) { // Forward
    ...
    motor1.drive(-100); // speed, optional duration
    motor2.drive(100);
  }
